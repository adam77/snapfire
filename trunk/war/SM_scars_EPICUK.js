...
var predatorsD =		{id:506, label:'Predators',					pts:275, defaults:[{unit:predatorA,count:4}], upgrades:[commander, hunter, vindicator]};
var scoutD =			{id:507, label:'Scout Detachment',			pts:150, units:'4 Scouts, Transport', upgrades:[commander, razorbacks, sniper]};
...
var tacticalD =			{id:511, label:'Tactical Detachment',		pts:300, units:'6 Tacticals, Transport', upgrades:[commander, razorbacks]};
var terminatorD =		{id:512, label:'Terminator Detachment',		pts:600, units:'4 Terminators', upgrades:[commander]};
...
var titanList = 		{id:523, label:'TITAN LEGIONS', options:[warhounds, warhound]};
