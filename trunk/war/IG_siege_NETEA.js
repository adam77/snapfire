...
var transports =			{id:10, label:'Deployment',	upto:1,	minimum:1};
	var bruennhilde =		{id:11, label:'Land Crawlers',	pts:0,	group:transports, optional:true};
...
var companyUpgrades = 	{id:25, label:'Upgrades', upto:3};
	...
	var sniper =			{id:34, label:'Sniper',								pts:25, upto:1, group:companyUpgrades};
	companyUpgrades.options = [infantry, rapiers, thudds, hellhounds, griffons, snipers, sniper];
var fort =				{id:35, label:'Fortified Position (Trenches, Razor Wire, Bunkers)',	pts:75, upto:1};

// SUPPORT (2 per company, no upgrades allowed)
var artCoy =		{id:500, label:'Artillery Company', 			pts:425, upgrades:[], restricted:true, units:'9 Gotterdammerung Howitzers, 9 Gun Emplacements'};
var artBattery =	{id:501, label:'Artillery Battery', 			pts:150, upgrades:[], restricted:true, units:'3 Gotterdammerung Howitzers, 3 Land Crawlers'};
var aaBattery =		{id:502, label:'Regiment AA Battery', 			pts:100, defaults:[{unit:bruennhilde,count:1}], upgrades:[], restricted:true, units:'3 Blitzen AA Guns'};
...
// COMPANIES
var hq = 			{id:512, label:'Regimental HQ', 				pts:225, upgrades:[companyUpgrades, fort], restricting:true, upto:1, units:'Supreme Commander, 9 Siege Infantry'};
var infantryCoy = 	{id:513, label:'Infantry Company', 				pts:175, upgrades:[companyUpgrades, fort], restricting:true, units:'Commander, 9 Siege Infantry'};
...
// DETAILS
var listData = {
	id:'Baran Siege Masters', version:'NetEA Compendium 1.0',
