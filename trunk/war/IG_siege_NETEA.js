...
var transports =		{id:10, label:'Deployment',	upto:1,	minimum:1, options:[
	...
	{id:11, label:'Land Crawlers',				pts:0,	optional:true}
]};
...
var companyUpgrades = 	{id:25, label:'Upgrades', 	upto:3, options:[
	...
	{id:34, label:'Sniper',								pts:25, upto:1}
]};
...
var supportList =	{id:511, label:'SUPPORT FORMATIONS', options:[
	{id:500, label:'Artillery Company', 			pts:425, upgrades:[], restricted:true, units:'9 Gotterdammerung Howitzers, 9 Gun Emplacements'},
	{id:501, label:'Artillery Battery', 			pts:150, upgrades:[], restricted:true, units:'3 Gotterdammerung Howitzers, 3 Land Crawlers'},
	{id:502, label:'Regiment AA Battery', 			pts:100, upgrades:[transports], restricted:true, units:'3 Blitzen AA Guns'},
	...
	{id:508, label:'Light Tank Platoon',			pts:150, upgrades:[], restricted:true, units:'6 Siegfried Light Tanks'},
