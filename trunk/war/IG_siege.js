...
var supportList =	{id:511, label:'SUPPORT FORMATIONS', options:[
	...
	{id:501, label:'Artillery Battery', 			pts:150, upgrades:[transports], restricted:true, units:'3 Gotterdammerung Howitzers'},
	{id:502, label:'Regiment AA Battery', 			pts:125, upgrades:[transports], restricted:true, units:'3 Blitzen AA Guns'},
...
var companyList =	{id:518, label:'COMPANIES', options:[
	{id:512, label:'Regimental HQ', 				pts:150, upgrades:[companyUpgrades, fort], restricting:true, upto:1, units:'Supreme Commander, 9 Siege Infantry'},
 	{id:513, label:'Infantry Company', 				pts:125, upgrades:[companyUpgrades, fort], restricting:true, units:'Commander, 9 Siege Infantry'}
]};
...
var navyList =			{id:521, label:'IMPERIAL NAVY', options:[
	...
	{id:520, label:'Marauder Bombers',				pts:300, upgrades:[], limited:true, units:'2 Marauders'}
]};
