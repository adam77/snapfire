...
var warwalkers =	{id:501, label:'War Walker Troupe',				pts:0, 		displayPts:140, defaults:[{unit:warwalker,count:4}], upgrades:[warwalker], restricted:true};
var windrider =		{id:502, label:'Windrider Troupe',				pts:200, 	defaults:[{unit:jetbike, count:6}], upgrades:[], restricted:true};
var swords =		{id:503, label:'Swords of Vaul Troupe',			pts:0, 	 	displayPts:250, defaults:[{unit:falcon2,count:5}], upgrades:[falcon2], restricted:true};
var nightspinner =	{id:504, label:'Night Spinner Troupe',			pts:175, 	units:'3 Night Spinners', upgrades:[], restricted:true};
var cobraT =		{id:505, label:'Engine of Vaul Troupe',			pts:0, 		displayPts:250, defaults:[{unit:cobra,count:1}], upgrades:[engines], restricted:true};
var troupeList = 	{id:506, label:'TROUPES', options:[rangers, warwalkers, windrider, swords, nightspinner, cobraT]};
