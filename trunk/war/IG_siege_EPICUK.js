...
var artBattery =	{id:501, label:'Artillery Battery', 			pts:175, defaults:[{unit:bruennhilde,count:1}], upgrades:[], restricted:true, units:'3 Gotterdammerung Howitzers'};
var aaBattery =		{id:502, label:'Regiment AA Battery', 			pts:150, defaults:[{unit:bruennhilde,count:1}], upgrades:[], restricted:true, units:'3 Blitzen AA Guns'};
...
var lighttank =		{id:508, label:'Light Tank Platoon',			pts:175, upgrades:[], restricted:true, units:'6 Siegfried Light Tanks'};
