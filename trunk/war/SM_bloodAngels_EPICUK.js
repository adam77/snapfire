...
var deathCompanyD =		{id:503, label:'Death Company',			pts:300, units:'4 Death Company', defaults:[{unit:rhinos,count:1}], upgrades:[chaplain, jumppacks, rhinos]};
...
var scoutD =			{id:508, label:'Scout Detachment',		pts:150, units:'4 Scouts', defaults:[{unit:rhinos,count:1}], upgrades:[commander, razorbacks, sniper, rhinos]};
...
var tacticalD =			{id:512, label:'Tactical Detachment',	pts:300, units:'6 Tacticals', defaults:[{unit:rhinos,count:1}], upgrades:[commander, razorbacks, dreadnoughts, hunter, vindicator, rhinos]};
