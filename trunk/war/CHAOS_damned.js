...
var alignment =		{id:18, label:'Alignment', upto:1, minimum:1, options:[
	{id:19, label:'Alignment: Khorne', pts:0, optional:true},
	{id:20, label:'Alignment: Nurgle', pts:0, optional:true},
	{id:21, label:'Alignment: Slaanesh', pts:0, optional:true},
	{id:22, label:'Alignment: Tzeentch', pts:0, optional:true},
	{id:23, label:'Alignment: Undivided', pts:0, optional:true}
]};
...
var companyList =	{id:530, label:'FORMATIONS', options:[
	{id:531, label:'Stigmatus Coven (Khorne)',			pts:35, displayPts:200, restricting:true, upgrades:[leaders,cultists,pact, icon, spawn, hound, altar, tanks, fireSup, griffon, hellhound, hydra, chimera, transports]},
	{id:532, label:'Stigmatus Coven (Nurgle)',			pts:35, displayPts:200, restricting:true, upgrades:[leaders,cultists,pact, icon, spawn, hound, altar, tanks, fireSup, griffon, hellhound, hydra, chimera, transports]},
	{id:533, label:'Stigmatus Coven (Slaanesh)',		pts:35, displayPts:200, restricting:true, upgrades:[leaders,cultists,pact, icon, spawn, hound, altar, tanks, fireSup, griffon, hellhound, hydra, chimera, transports]},
	{id:534, label:'Stigmatus Coven (Tzeentch)',		pts:35, displayPts:200, restricting:true, upgrades:[leaders,cultists,pact, icon, spawn, hound, altar, tanks, fireSup, griffon, hellhound, hydra, chimera, transports]},
	{id:535, label:'Stigmatus Coven (Undivided)',		pts:35, displayPts:200, restricting:true, upgrades:[leaders,cultists,pact, icon, spawn, hound, altar, tanks, fireSup, griffon, hellhound, hydra, chimera, transports]},
