...
var battleFortress =	{id:90, label:'Battlefortress',					pts:115};
var battleFortress1 =	{id:91, label:'Extra Battlefortress',			pts:115, upto:1};
var battleFortress2 =	{id:92, label:'Extra Battlefortress',			pts:115, upto:2};
var battleFortress3 =	{id:93, label:'Extra Battlefortress',			pts:115, upto:3};
var gunFortress =		{id:94, label:'Gunfortress',					pts:125};
var gunFortress1 =		{id:95, label:'Extra Gunfortress',				pts:125, upto:1};
var gunFortress2 =		{id:96, label:'Extra Gunfortress',				pts:125, upto:2};
var gunFortress3 =		{id:97, label:'Extra Gunfortress',				pts:125, upto:3};
...
var warbandList =		{id:515, label:'FORMATIONS', options:[	
	...
	{id:501, label:'Speed Freaks Warband (Big)',	pts:-45, displayPts:375, upgrades:[nob2, boy2, stormboyz, kult2, bigGun, battlewagon, dethKopta, flakwagon, gunwagon, speedsta2, badork]},
	{id:502, label:'Speed Freaks Warband (\'Uge)',	pts:-80, displayPts:550, upgrades:[nob3, boy3, stormboyz, kult3, bigGun, battlewagon, dethKopta, flakwagon, gunwagon, speedsta3, badork]},
	...
	{id:506, label:'Blitz Brigade',					pts:10,  displayPts:150, upgrades:[buggy, warbike, skorcha, blitz1, speedsta1, gunFortress1, nobgroup1, badork]},
	{id:507, label:'Blitz Brigade (Big)',			pts:-30, displayPts:250, upgrades:[buggy, warbike, skorcha, blitz2, speedsta2, gunFortress2, nobgroup2, badork]},
	{id:508, label:'Blitz Brigade (\'Uge)',			pts:-70, displayPts:350, upgrades:[buggy, warbike, skorcha, blitz3, speedsta3, gunFortress3, nobgroup3, badork]},
	{id:509, label:'Warbike Outriders',				pts:150, units:'5 Warbikes', upgrades:[badork]},
	{id:510, label:'Warbike Outriders (Big)',		pts:250, units:'10 Warbikes', upgrades:[badork]},
	{id:511, label:'Warbike Outriders (\'Uge)',		pts:350, units:'15 Warbikes', upgrades:[badork]},
	{id:512, label:'Fortress Mob',					pts:275, upgrades:[forts1, boyz, flakwagon, nobgroup1, battleFortress1, gunFortress1, badork]},
	{id:513, label:'Fortress Mob (Big)',			pts:475, upgrades:[forts2, boyz, flakwagon, nobgroup2, battleFortress2, gunFortress2, badork]},
	{id:514, label:'Fortress Mob (\'Uge)',			pts:675, upgrades:[forts3, boyz, flakwagon, nobgroup3, battleFortress3, gunFortress3, badork]}
]};
...
var othersList = 		{id:521, label:'AIRCRAFT and SPACECRAFT', options:[
	...
	{id:519, label:'Kill Kroozer',		pts:150, upgrades:[], limited:true, group:spacecraft},
