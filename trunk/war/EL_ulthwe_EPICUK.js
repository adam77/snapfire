...
var guardians =		{id:23, label:'Guardians',	upto:6, minimum:6, options:[
...
var seers = {id:101, label:'Seers', upto:2, minimum:2, options:[
	{id:102, label:'Farseers', pts:0, optional:true},
	{id:103, label:'Seer Council', pts:100, upto:1, optional:true, general:true}
]};
var transport = {id:110, label:'Aspect Transport', upto:6, options:[
	{id:41, label:'Wave Serpent',	upto:3,	pts:50},
	{id:42, label:'Falcon',	upto:6,	pts:65}
]};
...
var troupeList = 	{id:506, label:'TROUPES', options:[
	...
	{id:531, label:'Aspect Troupe', pts:250, upgrades:[aspects, transport, exarchs]}
]};
...
// DETAILS
var listData = {
	id:'Ulthw&eacute; Craftworld', version:'Epic-UK v20101230',
