...
\upgrade{Support Vehicles}
		{Add up to three units \hspace{\stretch{1}} Predator, Stalker \newline ... \hspace{\stretch{1}} Land Raider}
        {50 points \newline 75 points}
\upgrade{Transport}
...
\upgrade{Walkers}
        {Add up to three units \hspace{\stretch{1}} Dreadnought \newline ... \hspace{\stretch{1}} Defiler, Desecrator }
        {50 points \newline 75 points}
\upgradesEND
