...
var lords = 		{id:16, label:'Lord', upto:1, minimum:1, options:[
	...
	{id:20, label:'Chaos Warlord (Supreme Commander)', pts:25, optional:true, general:true},
...
var term = 			{id:32, label:'Chaos Terminator', pts:65, optional:true, upto:6, minimum:4};
...
var elite =	{id:502, label:'ELITE', options:[
	{id:503, label:'Chaos Terminators',		restricted:true, pts:15, 	displayPts:275, upgrades:[faction,lords,term, dread, defiler, raiders, obliterator, pact, champion, icon]},
	{id:504, label:'Black Legion Chosen',	restricted:true, pts:125, units:'4 Chaos Space Marine Scouts', upgrades:[faction,rhino, claws, dread, pact]},
...
var navyList =			{id:535, label:'CHAOS NAVY', options:[
	{id:530, label:'Hellblade Flight',	pts:225, units:'3 Fighters', upgrades:[], limited:true},
	{id:531, label:'Helltalon Flight',	pts:175, units:'2 Bombers', upgrades:[], limited:true},
	{id:532, label:'Harbinger Bomber',	pts:450, upgrades:[], limited:true},
...
// DETAILS
var listData = {
	id:'Black Legion', version:'NetEA v3.1 *UNDER DEVELOPMENT*',
