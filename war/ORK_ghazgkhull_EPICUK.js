...
var stormerz =		{id:34, label:'Stormboyz',	minimum:6, options:[
	{id:35, label:'Stormboyz',		pts:25, optional:true},
	{id:90, label:'Commandos',		pts:25, optional:true}
]};
...
var warbandList =		{id:516, label:'WAR HORDES', options:[
	...
	{id:503, label:'Stormboyz Warhorde',	pts:0,		displayPts:150, upgrades:[stormerz, buggy, warbike, skorcha, dethKopta]},
...
var othersList = 		{id:524, label:'AIRCRAFT, SPACECRAFT &amp; GARGANTS', options:[
	...
	{id:520, label:'Kill Kroozer',		pts:150, upgrades:[], limited:true, group:spacecraft},
