...
var bigWarband =		{id:501, label:'Speed Freaks Warband (Big)',	pts:-45, displayPts:375, defaults:[{unit:nobtrukk2,count:2},{unit:bo2,count:6},{unit:buggy3,count:8}], upgrades:[nobtrukk2, nobbike2, bo2, stormboyz, buggy3, warbike3, skorcha3, bigGun, battlewagon, dethKopta, flakwagon, gunwagon, speedsta2, badork]};
var ugeWarband =		{id:502, label:'Speed Freaks Warband (\'Uge)',	pts:-80, displayPts:550, defaults:[{unit:nobtrukk3,count:3},{unit:bo3,count:9},{unit:buggy4,count:12}], upgrades:[nobtrukk3, nobbike3, bo3, stormboyz, buggy4, warbike4, skorcha4, bigGun, battlewagon, dethKopta, flakwagon, gunwagon, speedsta3, badork]};
...
var blitz =				{id:506, label:'Blitz Brigade',					pts:10,  displayPts:150, defaults:[{unit:gunwagon2,count:4}], upgrades:[buggy, warbike, skorcha, gunwagon2, deth2, flak2, speedsta1, gunFortress1, nobgroup1, badork]};
var bigBlitz =			{id:507, label:'Blitz Brigade (Big)',			pts:-30, displayPts:250, defaults:[{unit:gunwagon3,count:8}], upgrades:[buggy, warbike, skorcha, gunwagon3, deth3, flak3, speedsta2, gunFortress2, nobgroup2, badork]};
var ugeBlitz =			{id:508, label:'Blitz Brigade (\'Uge)',			pts:-70, displayPts:350, defaults:[{unit:gunwagon4,count:12}], upgrades:[buggy, warbike, skorcha, gunwagon4, deth4, flak4, speedsta3, gunFortress3, nobgroup3, badork]};
var outriders =			{id:509, label:'Warbike Outriders',				pts:150, units:'5 Warbikes', upgrades:[badork]};
var bigOutriders =		{id:510, label:'Warbike Outriders (Big)',		pts:250, units:'10 Warbikes', upgrades:[badork]};
var ugeOutriders =		{id:511, label:'Warbike Outriders (\'Uge)',		pts:350, units:'15 Warbikes', upgrades:[badork]};
var fortressMob =		{id:512, label:'Fortress Mob',					pts:275, defaults:[{unit:battlefort,count:2}], upgrades:[boyz, flakwagon, nobgroup1, battleFortress1, gunFortress1, badork]};
var bigFortressMob =	{id:513, label:'Fortress Mob (Big)',			pts:475, defaults:[{unit:battlefort2,count:4}], upgrades:[boyz, flakwagon, nobgroup2, battleFortress2, gunFortress2, badork]};
var ugeFortressMob =	{id:514, label:'Fortress Mob (\'Uge)',			pts:675, defaults:[{unit:battlefort3,count:6}], upgrades:[boyz, flakwagon, nobgroup3, battleFortress3, gunFortress3, badork]};
...
var killKroozer =		{id:519, label:'Kill Kroozer',		pts:150, upgrades:[], limited:true, group:spacecraft};
