...
var troupeList = 	{id:506, label:'TROUPES', options:[
	...
	{id:501, label:'War Walker Troupe',			pts:200,	units:'6 Warwalkers',	upgrades:[], restricted:true},
	{id:502, label:'Windrider Troupe',			pts:200, 	upgrades:[jetbikers], restricted:true},
	{id:503, label:'Falcon Troupe',				pts:0, 	 	displayPts:250, upgrades:[falcons], restricted:true},
	{id:504, label:'Night Spinner Troupe',		pts:175, 	units:'3 Night Spinners', upgrades:[], restricted:true},
	{id:505, label:'Engines of Vaul Troupe',	pts:0, 		displayPts:250, upgrades:[engines], restricted:true},
	{id:530, label:'Fire Prism Troupe',			pts:250, 	units:'3 Fire Prisms', upgrades:[], restricted:true}
]};
