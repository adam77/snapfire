...
var companyUpgrades = 	{label:'Upgrades', upto:3};
	...
	var fireSupport =		{label:'Fire Support Platoon (4 Fire Support)',	pts:100, upto:1, group:companyUpgrades};
	var infantry =			{label:'Infantry Platoon (6 Infantry)',		pts:100, upto:1, group:companyUpgrades};
	var tankSquadron =		{label:'Tank Squadron (3 Leman Russ)',		pts:200, upto:1, group:companyUpgrades};
	var demolisher =		{label:'Tank Squadron (3 Demolishers)',		pts:200, upto:1, group:companyUpgrades};
	var hellhounds =		{label:'Hellhound Squadron (3 Hellhounds)',	pts:150, upto:1, group:companyUpgrades};
	var griffons =			{label:'Griffon Battery (3 Griffons)',		pts:100, upto:1, group:companyUpgrades};
	var snipers =			{label:'2 Snipers',							pts:50, upto:1, group:companyUpgrades};
	var ogryns =			{label:'2 Ogryns',							pts:50, upto:1, group:companyUpgrades};
