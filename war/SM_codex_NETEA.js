...
var commander =			{label:'Cmdr', upto:1};
	...
	var captainSupreme = 	{id:18, label:'Captain (Supreme Commander)',	pts:100, group:commander};
	var chaplainSupreme =	{id:19, label:'Chaplain (Supreme Commander)',	pts:100, group:commander};
	var librarianSupreme =	{id:20, label:'Librarian (Supreme Commander)', 	pts:100, group:commander};
