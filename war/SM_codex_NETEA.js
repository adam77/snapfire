...
var landRaiderD = 		{label:'Land Raider',	pts:350, upgrades:[commander, hunter, vindicator]};
...
var terminatorD =		{label:'Terminator',	pts:350, upgrades:[commander, vindicator, dreadnought, landRaiders]};
var thunderhawkD =		{label:'Thunderhawk',	pts:200, upgrades:[]};
var vindicatorD =		{label:'Vindicator',	pts:275, upgrades:[commander, hunter]};
