...
var independent = {id:500, label:'INDEPENDENT SWARMS', options:[
	...
	{id:505, label:'Harassment Swarm', pts:175, units:'Harridan', upgrades:[gargoyles], limited:true},
...
var synapse = {id:530, label:'SYNAPSE GROUPS', options:[
	{id:531, label:'Assault Group', pts:-25, displayPts:125, upgrades:[warriors, zoanthropes], limited2:true},
	{id:532, label:'Attack Group', pts:0, displayPts:100, upgrades:[tyrant, zoanthropes], limited2:true},
	{id:533, label:'Hive Group', pts:475, units:'Dominatrix Bio-Titan', upgrades:[zoanthropes], group:hivegroup, limited2:true},
	{id:534, label:'Infestation Group', pts:125, units:'Synapse Node', upgrades:[zoanthropes], limited2:true},
	{id:535, label:'Strike Group', pts:300, units:'Vituperator Bio-Titan', upgrades:[zoanthropes], limited2:true}
]};
...
// DETAILS
var listData = {
	id:'Phase IV \'Subdual\' Tyranids', version:'NetEA v9.2.1 *UNDER DEVELOPMENT*',
	sublists:[synapse, common, uncommon, independent],
	restriction:{limit:0.5, restricting:'Common Brood Groups', restricted:'Uncommon Brood Group'},
	limitLabel:'Independent Swarms',
	limitLabel2:'Synapse Groups'
};
