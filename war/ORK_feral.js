...
var trappas =			{id:509, label:'Trappas',				pts:150,	units:'6 Wildboyz', upgrades:[nobz1]};
var madhorde =			{id:510, label:'Madboyz Horde',			pts:10,		displayPts:100, 	upto:1, defaults:[{unit:mad1,count:6}], upgrades:[mad1, wyrdboy3]};
var junkbrigade =		{id:511, label:'Junka Brigade',			pts:0,		displayPts:150,		units:'Junka Trukks', defaults:[{unit:boy1,count:6}], upgrades:[boy1, nobz1, wyrdboy1, warlord]};
var junkbrigadebig =	{id:512, label:'Junka Brigade (Big)',	pts:-50,	displayPts:250,		units:'Junka Trukks', defaults:[{unit:boy2,count:12}], upgrades:[boy2, nobz2, wyrdboy2, warlord]};
var junkbrigadeuge =	{id:513, label:'Junka Brigade (\'Uge)',	pts:-100,	displayPts:350,		units:'Junka Trukks', defaults:[{unit:boy3,count:18}], upgrades:[boy3, nobz3, wyrdboy3, warlord]};
var steamGargant =		{id:514, label:'Steam Gargant',			pts:50,		displayPts:200,		upto:1, defaults:[{unit:steam1,count:1}], upgrades:[steam1]};
var warbandList =		{id:516, label:'WAR HORDES', options:[warband, bigWarband, ugeWarband, wildboyzmob, bigwildboyz, ugewildboyz, boarhorde, boarhordebig, boarhordeuge, trappas, madhorde, junkbrigade, junkbrigadebig, junkbrigadeuge, steamGargant]};
