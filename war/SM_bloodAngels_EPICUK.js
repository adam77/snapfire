...
var deathCompanyD =		{label:'Death Company',			pts:300, units:'4 Death Company', upgrades:[chaplain, jumppacks]};
var landRaiderD = 		{label:'Land Raiders',			pts:350, units:'4 Land Raiders', upgrades:[commander, hunter, vindicator]};
var landSpeederD =		{label:'Land Speeders',			pts:200, defaults:[{unit:speeder,count:5}], upgrades:[commander, speeders]};
...
var tacticalD =			{label:'Tactical Detachment',	pts:300, units:'6 Tacticals', upgrades:[commander, razorbacks, dreadnoughts, hunter, vindicator]};
