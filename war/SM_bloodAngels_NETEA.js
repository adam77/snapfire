...
var fastAttack = 		{label:'Fast Attack', upto:1};
	var landSpeeder =			{label:'Fast Attack (Land Speeders)',		pts:100, group:fastAttack};
	var bike =				{label:'Fast Attack (Bikes)',				pts:100, group:fastAttack};
	var bike =				{label:'Fast Attack (Attack Bikes)',		pts:100, group:fastAttack};
	fastAttack.options = 	[landSpeeder, bike];
var heavySupport = 		{label:'Heavy Support', upto:2};
	var vindicators = 		{label:'Heavy Support (Baal Vindicators)',	pts:100, group:heavySupport};
	var destructors =		{label:'Heavy Support (Baal Destructors)',	pts:125, group:heavySupport};
	var annihilators =		{label:'Heavy Support (Baal Annihilators)',	pts:150, group:heavySupport};
	var baals =				{label:'Heavy Support (Baal Predators)',	pts:150, group:heavySupport};
	var landRaiders =		{label:'Heavy Support (Land Raiders)',		pts:175, group:heavySupport};
	var redeemers =			{label:'Heavy Support (Land Raider Redeemers)',	pts:175, group:heavySupport};
...
var deathCompanyD =		{label:'Death Company',				pts:300, units:'Chaplain, 4 Death Company', upgrades:[dreads], upto:1};
var devastatorD = 		{label:'Devastator Detachment',		pts:250, units:'4 Devastators', upgrades:[commander, heavySupport, hunter, razorbacks, dreads]};
...
var scoutD =			{label:'Scout Detachment',			pts:150, units:'4 Scouts', upgrades:[commander]};
...
var tacticalD =			{label:'Tactical Detachment',		pts:300, units:'6 Tactical Units', upgrades:[commander, assault, razorbacks, dreads, hunter, fastAttack, heavySupport]};
...
var detachments =		{label:'DETACHMENTS', options:[assaultD, battleBargeD, devastatorD, landSpeederD, landingCraftD, scoutD, strikeCruiserD, tacticalD, terminatorD, thunderhawkD, whirlwindD]};
