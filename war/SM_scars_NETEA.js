...
var speeders =			{id:16, label:'Speeders', upto:5, minimum:5};
	...
	var tornado =			{id:18, label:'Tornado',						pts:0, group:speeders, optional:true};
...
var bikeD = 			{id:501, label:'Bike Detachment', 			pts:375, defaults:[{unit:bike,count:8}], upgrades:[commander]};
